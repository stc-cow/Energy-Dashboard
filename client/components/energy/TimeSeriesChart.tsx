          ...
          >
            <defs>
              <linearGradient id="d1" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor="hsl(var(--metric-diesel))"
                  stopOpacity={0.4}
                />
                <stop
                  offset="95%"
            ...
            <Area
              ...
              type="monotone"
              dataKey="CO2"
              stroke="hsl(var(--metric-co2))"
              fillOpacity={0.1}
              fill="hsl(var(--metric-co2))"
            />
            <Area
              yAxisId="r"
              type="monotone"
              dataKey="Efficiency"
              stroke="hsl(var(--metric-yellow))"
              fillOpacity={0.05}
              fill="hsl(var(--metric-yellow))"
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
